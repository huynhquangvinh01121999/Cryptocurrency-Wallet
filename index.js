...
var data = JSON.parse(fs.readFileSync("./src/Transactions/transactions.json", "utf8"));

const blockChain = new BlockChain(1);
data.transactions.map(trans => {
  blockChain.addToBlockChain(new Transaction(trans.sender, trans.receiver, trans.amount, trans.gasFee))
})
